...
fn test_http_get() {
    ...
    assert!(
        result.is_ok(),
        "Failed to compile test_get.liva: {:?}",
        result.err()
    );
}
...
fn test_http_post() {
    ...
    assert!(
        result.is_ok(),
        "Failed to compile test_post.liva: {:?}",
        result.err()
    );
}
...
fn test_http_put() {
    ...
    assert!(
        result.is_ok(),
        "Failed to compile test_put.liva: {:?}",
        result.err()
    );
}
...
fn test_http_delete() {
    ...
    assert!(
        result.is_ok(),
        "Failed to compile test_delete.liva: {:?}",
        result.err()
    );
}
...
fn test_http_errors() {
    ...
    assert!(
        result.is_ok(),
        "Failed to compile test_errors.liva: {:?}",
        result.err()
    );
}
