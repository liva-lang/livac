...
> **Lenguaje:** Rust  
> **Tests:** 518 passing  
> **Próximo objetivo:** v2.0 — Fase 2.5 Class/Enum metadata (self-hosting)  
...
- **518 tests** totales
- **Self-hosting:** Fase 2.4 completada — `compiler/src/semantic.liva` (1506 líneas) Function signatures + param types + return validation
