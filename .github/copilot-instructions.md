...
- **LSP capabilities:** completion, hover, signature, definition, **implementation**, references, document/workspace symbols, document highlight, selection range, document link (imports), **rename** (intra-file), formatting, diagnostics — `livac lsp`
