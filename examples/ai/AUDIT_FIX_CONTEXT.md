...
| **Este archivo** | `livac/examples/ai/AUDIT_FIX_CONTEXT.md` |
...
- [ ] **B01** — `_` no aceptado en error binding (`let val, _ = fn()`)  
  Archivo: `parser.rs` o `codegen.rs` | Proyectos: csv-reader, json-parser, rest-api
